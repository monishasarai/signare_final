  ...
  return (
    <div className="about-us-container">
      ...
      <section className="how-it-works">
        <h2>How Does Signature Verification Work?</h2>
        <ul>
      ...
      <section className="applications">
        <h2>How Is Signature Verification Used?</h2>
        <p>
      ...
      <section className="benefits">
        <h2>What Are The Benefits of Signature Verification for Businesses?</h2>
        <ul>
      ...
      <section className="legal-requirements">
        <h2>Are There Any Legal Requirements for Signature Verification?</h2>
        <p>
      ...
      <section className="types-of-verification">
        <h2>What Are the Different Types of Signature Verification?</h2>
        <ul>
